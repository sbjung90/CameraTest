...
#endif
{
	...
	public void ProcessInput ( Vector2 inputPosition )
	{
    ...
    void TensionAccentDisplay ()
	{
		...
		{
            DirectionalDisplay((joystick.localPosition * ParentCanvas.scaleFactor) / radius);
		}
    ...
    public void DirectionalDisplay(Vector2 value) {
        // Calculate the joystick axis values.
        Vector2 joystickAxis = value;
